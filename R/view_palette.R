...
#'   \item{Semantic}{Where applicable, use colors that are associated with certain concepts. For e.g., gender1, gender2, and gender3 shows male and female data, and pos_neg1 and pos_neg2 show pros and cons or positive and negative data}
