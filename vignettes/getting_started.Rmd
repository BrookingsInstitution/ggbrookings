...
knitr::opts_chunk$set(collapse = TRUE, comment = "#>", warning = FALSE,
                      message = FALSE, tidy = TRUE, background = '#FAFAFA', fig.width = 7, fig.height = 7, fig.align = "center")
```
...
devtools::install_github("malcalakovalski/ggbrookings", build_vignettes = TRUE)
```
