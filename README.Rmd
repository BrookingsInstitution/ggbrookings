...
## Overview
`ggbrookings` is a `ggplot2` extension which implements the Brookings style guide using `ggplot2`. It offers several color palettes, a custom theme, and a few helper functions.
